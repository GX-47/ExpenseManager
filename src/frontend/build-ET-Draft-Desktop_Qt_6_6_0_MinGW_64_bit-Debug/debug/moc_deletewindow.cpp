...
#include "../../ET-Draft/deletewindow.h"
...
static constexpr auto qt_meta_stringdata_CLASSdeleteWindowENDCLASS = QtMocHelpers::stringData(
    "deleteWindow",
    "loadDataFromCSV",
    "",
    "filename",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSdeleteWindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSdeleteWindowENDCLASS_t qt_meta_stringdata_CLASSdeleteWindowENDCLASS = {
    {
        QT_MOC_LITERAL(0, 12),  // "deleteWindow"
        QT_MOC_LITERAL(13, 15),  // "loadDataFromCSV"
        QT_MOC_LITERAL(29, 0),  // ""
